 ...
 * come from a mapping that does not describe the table it points at.
 */
export type PlanCompilationReason =
	...
	| "value-kind-mismatch"
	/** A mapping is structurally unusable (a malformed hierarchy entry, a bad escape char). */
	| "invalid-mapping";
...
/**
 * Base class for every refusal `planToSql` can make.
 *
